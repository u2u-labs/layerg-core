...
type LayerGClient interface {
	...
	LinkMetamask(ctx context.Context, in *api.AccountMetamask, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *layerGClient) LinkMetamask(ctx context.Context, in *api.AccountMetamask, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
type LayerGServer interface {
	...
	LinkMetamask(context.Context, *api.AccountMetamask) (*emptypb.Empty, error)
	// Add a custom ID to the social profiles on the current user's account.
...
func (UnimplementedLayerGServer) LinkMetamask(context.Context, *api.AccountMetamask) (*emptypb.Empty, error) {
...
func _LayerG_LinkMetamask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LayerGServer).LinkMetamask(ctx, req.(*api.AccountMetamask))
	}
	return interceptor(ctx, in, info, handler)
}
